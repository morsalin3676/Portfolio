          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-between mt-4">
                <a href="#" className="px-4 py-2 rounded-lg bg-purple-600 text-white font-semibold flex items-center gap-2 hover:bg-purple-700 transition-all">
                  Code <FiArrowUpRight />
                </a>
                <a href="#" className="px-4 py-2 rounded-lg bg-white/20 border border-white/30 backdrop-blur-md text-gray-900 dark:text-white font-semibold flex items-center gap-2 hover:bg-white/30 transition-all">
                  Demo <FiArrowUpRight />
                </a>
              </div>
            </div>
